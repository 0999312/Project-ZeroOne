package zaia_enterprise.project_zeroone.client.gui.button;
...
public class ButtonZeroOne extends Button {

	public ButtonZeroOne(int p_i232256_1_, int p_i232256_2_, int p_i232256_3_, int p_i232256_4_,
